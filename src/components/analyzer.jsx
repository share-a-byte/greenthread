...
export function Analyzer() {
  return (
    <main className="flex flex-col items-center justify-center w-full min-h-screen bg-gray-100 dark:bg-gray-900 p-4 md:p-8">
      <div className="max-w-3xl w-full">
        ...
        <div className="mt-12 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <ScoreCard score="85" title="Energy Efficiency" color="green-500" />
            <ScoreCard score="92" title="Waste Reduction" color="blue-500" />
            <ScoreCard score="69" title="Ethical Sourcing" color="indigo-300" />
          </div>
